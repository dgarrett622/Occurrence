...
et al. 2015, ApJ, 810, 95).  The files eta_g.txt, sigma_p_g.txt, and
sigma_n_g.txt are for the combined GK dwarf sample selected according
to the criteria outlined in B15.
...
Includes a file extrap_g.txt which is 1/0 flag with 1 indicating the grid value includes extrapolating the parameteric model.
